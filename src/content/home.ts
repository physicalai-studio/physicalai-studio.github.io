...
export const home = homeSchema.parse({
  ...
  problems: {
    ...
    */
    ...
    items: [
      "이 공정에 로봇을 도입하는 것이 맞는지 구매 전에 검토하고 싶습니다.",
      "후보 로봇은 있는데 가반하중 · 도달 범위 · 사이클 타임을 비교하기 어렵습니다.",
  ...
  */
  customers: {
    ...
    title: "도입을 검토하는 팀부터, 이미 로봇이나 지능을 가진 팀까지",
    body: "구매 전에는 맞는 로봇과 구성을 판단하고, 도입 후에는 반복해서 개발 · 검증 · 연구할 디지털 환경을 만듭니다.",
  },
  ...
  contact: {
    ...
    body: "도입 전이라면 현재 공정과 자동화할 작업을, 이미 로봇이 있다면 장비와 시나리오를 알려주세요. 먼저 검토할 질문과 필요한 자료부터 정리해 드립니다.",
