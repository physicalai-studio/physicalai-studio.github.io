 ...
 * 기술 스택 (가이드 §10).
 *
 * 로고 나열을 금지하고, 각 기술이 **파이프라인에서 수행하는 역할**을 함께 기술한다.
 * 항목은 실제 수행 경험이 있는 것만 둔다 — 근거는 저장소 밖 비공개 역량 대장에 있다.
 *
 * ROBOTICS 그룹은 "우리가 만드는 로봇"이 아니라 **모델로 세우고 실기와 대조해 본 로봇의 범위**다
 * (사업_정의.md §1-1). 로봇을 아는 것이 시뮬레이션의 근거이지, 제작이 우리 일은 아니다.
 */
export const technologyGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "차동 구동 AMR",
        role: "구동 기구학 · 오도메트리 · 안전 계층을 모델로 세우고 실기와 대조",
      },
...
export const workflowSteps = [
  {
    id: "problem",
    label: "PROBLEM",
    body: "고객이 확인하고 싶은 것을, 재서 답할 수 있는 엔지니어링 질문으로 바꿉니다.",
  },
  {
    id: "model",
    label: "MODEL",
  ...
  },
  {
    id: "deploy",
    label: "DEPLOY",
    body: "검증된 구성이 실기에 그대로 올라갑니다 — 시뮬레이션에서 쓰던 명령 경로와 계약을 유지한 채.",
  },
  {
    id: "measure",
    label: "MEASURE",
