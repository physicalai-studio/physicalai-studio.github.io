...
| 19a | `HeroSection`          | 없음                                  | `JSX`                   | 전체 화면 Hero(비주얼 + 스크림 3겹 + 카피 + CTA)               | `app/page.tsx:39`                          |
| 19b | `ProblemsSection`      | 없음                                  | `JSX`                   | 01 — 고객이 가지고 오는 질문 목록                              | `app/page.tsx:80`                          |
| 19c | `ServicesSection`      | 없음                                  | `JSX`                   | 02 — 서비스 5종 요약 행, 상세로 링크                           | `app/page.tsx:108`                         |
| 19d | `WorkflowSection`      | 없음                                  | `JSX`                   | 03 — Problem → Deploy 5단계                                    | `app/page.tsx:141`                         |
| 19e | `ProjectsSection`      | 없음                                  | `JSX`                   | 04 — 케이스 스터디 최대 4건 그리드                             | `app/page.tsx:167`                         |
| 19f | `TechnologySection`    | 없음                                  | `JSX`                   | 05 — 기술 그룹 4열 요약                                        | `app/page.tsx:203`                         |
| 19g | `WhySection`           | 없음                                  | `JSX`                   | 06 — 비주얼 + 회사 원칙                                        | `app/page.tsx:237`                         |
| 19h | `ContactSection`       | 없음                                  | `JSX`                   | 07 — 전체 화면 문의 CTA                                        | `app/page.tsx:267`                         |
